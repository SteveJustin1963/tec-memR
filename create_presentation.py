...
slides = [
    ...
    },
    {
        ...
        "content": [
            ...
            "",
            "Ongoing: Hybrid approach balances practicality",
            "and performance"
        ]
    },
    {
        ...
        "content": [
            ...
            "",
            "Long-term: Scale to FPGA implementation",
            "with 100+ neurons"
        ]
    },
    {
        ...
        "content": [
            ...
            "",
            "Key References:",
            "• Frontiers in Nanotechnology (crossbar arrays)",
            "• Nyle Steiner's memristor work",
            "• DIY electronics forums",
            "",
            "Related Projects:",
            "• tec-iDADmm (crossbar matrix)",
 ...
 <office:styles>
  ...
  <style:style style:name="Content" style:family="presentation">
   <style:text-properties fo:font-size="28pt"/>
    ...
    # Build content.xml with all slides
 ...
 <office:body>
  <office:presentation>'''
   ...
   <draw:page draw:name="slide{i+1}" draw:master-page-name="Default">
    <draw:frame draw:layer="layout" svg:width="25cm" svg:height="3cm" svg:x="2cm" svg:y="2cm">
     <draw:text-box>
      <text:p text:style-name="Title">{slide["title"]}</text:p>
     </draw:text-box>
    </draw:frame>
    <draw:frame draw:layer="layout" svg:width="25cm" svg:height="14cm" svg:x="2cm" svg:y="6cm">
     <draw:text-box>'''

        for line in slide["content"]:
            if line:
                slides_xml += f'''
      <text:p text:style-name="Content">{line}</text:p>'''
            else:
                slides_xml += '''
      <text:p text:style-name="Content"></text:p>'''
